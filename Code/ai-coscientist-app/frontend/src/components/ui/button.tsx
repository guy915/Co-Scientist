...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "shadow btn-default",
        destructive: "shadow-sm btn-destructive",
        outline: "border shadow-sm btn-outline",
        secondary: "shadow-sm btn-secondary",
        ghost: "btn-ghost",
        link: "underline-offset-4 hover:underline btn-link",
      },
      size: {
